  ...
  def create
    ...
    respond_to do |format|
      if @loan_application.save
        format.html { redirect_to loan_application_url(@loan_application), notice: "Loan application was successfully created." }
  ...
  def update
    respond_to do |format|
      if @loan_application.update(loan_application_params)
        format.html { redirect_to loan_application_url(@loan_application), notice: "Loan application was successfully updated." }
